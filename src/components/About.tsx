  ...
  return (
    <section className="py-32 px-6 relative">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl border border-border/50 rounded-3xl p-10 md:p-12 shadow-elevated hover:shadow-primary/10 hover:border-primary/30 transition-all duration-500 group">
